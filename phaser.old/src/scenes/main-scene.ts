...
export class MainScene extends Phaser.Scene
{
    ...
    protected create(): void
    {
        ...
        this._inputArea = this.add.dom(this.game.canvas.width/2, 50).createFromCache("inputArea");
        this._inputArea.setOrigin(0.5, 0);
    ...
    protected handleOrientationChanged()
    {
        ...
        this._inputArea.setPosition(this.game.canvas.width/2, 50);
